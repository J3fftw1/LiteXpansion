...
final class ItemSetup {
    ...
    private void registerSolarPanels() {
        new BasicSolarPanel(BasicSolarPanel.Type.BASIC).register(plugin);
        new BasicSolarPanel(BasicSolarPanel.Type.LOW_VOLTAGE).register(plugin);
        new BasicSolarPanel(BasicSolarPanel.Type.MEDIUM_VOLTAGE).register(plugin);
        new BasicSolarPanel(BasicSolarPanel.Type.HIGH_VOLTAGE).register(plugin);
